...
(function(global, factory) {
    ...
    'use strict';
	var headerHeight = 127;//臾몄쁺 header�믪씠
	var headerTHeight= 65;
	var headerMHeight= 65;
 ...
 of the active section.
        ...
        */
        ...
        FP.reBuild = function(resizing){
			...
			if (windowsWidth< 768)	{
				windowsHeight = $window.height()-headerMHeight;  //updating global var
			} else if (windowsWidth<1025)	{
				windowsHeight = $window.height()-headerTHeight;  //updating global var
			} else {
        ...
        */
		...
		var windowsWidth = $window.width();
			...
			if (windowsWidth< 768 )	{
				var windowsHeight = $window.height()-headerMHeight;
			} else if (windowsWidth<1025)	{
				var windowsHeight = $window.height()-headerTHeight;
			} else {
